#
# $Id: fftk_guiProcs.tcl,v 1.24 2012/11/15 17:31:58 mayne Exp $
#
...
proc ::ForceFieldToolKit::gui::baoptGuessPars {} {
    ...
    if { [llength $errorList] > 0 } {
        foreach ele $errorList {
            set errorText [concat $errorTest\n$ele]
        }
        tk_messageBox \
            -type ok \
            -icon warning \
    ...
    # angles
    foreach angle [lsearch -index 0 -inline -all $replicateAvgZmat "angle"] {
