#
# $Id: fftk_ChargeOpt.tcl,v 1.18 2012/11/12 18:46:38 mayne Exp $
#
...
proc ::ForceFieldToolKit::ChargeOpt::optimize {} {
    ...
    foreach log $logFileList {
       ...
       mol addfile base-wat.pdb molid $refmolid waitfor all
    ...
    # parse dipole data
    set dipoleData [::ForceFieldToolKit::ChargeOpt::getDipoleData $baseLog]
    ...
    for {set i 0} {$i < [molinfo $refmolid get numframes]} {incr i} {
        ...
        for {set d $start} {$d <= $end} {set d [expr $d+$delta]} {
            mol addfile base-wat-optpos.pdb molid $currTraj waitfor all
