#
# $Id: fftk_guiInterface.tcl,v 1.24 2012/11/01 20:11:58 mayne Exp $
#
...
### ===================================================================================
    ...
    ttk::label $baopt.results.eqLbl -text "b\u2080/\u03F4" -anchor center
    ...
    ttk::label $gds.dihs2scan.plusMinusLbl -text "Scan +/- (\u00B0)" -anchor center
    ...
    grid columnconfigure $gds.generate {0 1} -uniform ct1 -weight 1
