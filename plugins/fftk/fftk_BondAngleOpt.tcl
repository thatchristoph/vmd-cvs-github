#
# $Id: fftk_BondAngleOpt.tcl,v 1.8 2012/11/01 20:11:58 mayne Exp $
#
...
proc ::ForceFieldToolKit::BondAngleOpt::optBondsAngles { baInput } {
    ...
    mol addfile $minName.coor molid $moleculeID
...
proc ::ForceFieldToolKit::BondAngleOpt::buildScript { scriptFilename } {
    ...
    puts $scriptFile "set ::ForceFieldToolKit::BondAngleOpt::inputBondPars $inputBondPars"
    puts $scriptFile "set ::ForceFieldToolKit::BondAngleOpt::inputAnglePars $inputAnglePars"
