...
proc ::Nanotube::nanotube_usage { } {
    variable ccbond
    vmdcon -info "Usage: nanotube -l <length> -n <n> -m <m> \[-b <0|1>\] \[-a <0|1>\] \[-d <0|1>\] \[-i <0|1>\] \[-cc <blength>\]"
...
proc ::Nanotube::nanotube_core { args } {
    ...
    foreach key {name resname segid element type mass radius} value {C CNT TUB C CA 12.0107 1.7} {
        $sel set $key $value
    }
