 ...
 *	$Revision: 1.119 $	$Date: 2012/09/07 16:26:27 $
 *
 ***************************************************************************
 * DESCRIPTION:
 *
...
protected:
  ...
  virtual void trimesh_n3v3(char *n, float *v, int numfacets) { 
    int i;
  ...
  /// triangle mesh built from a vertex array
  virtual void trimesh_c4n3v3(unsigned char *c, float *n, float *v, 
                              int numfacets) { 
    int i, j;
    const float ci2f = 1.0f / 255.0f;
  ...
  /// triangle mesh built from a vertex array
  virtual void trimesh_c4n3v3(unsigned char *c, char *n, float *v, 
                              int numfacets) { 
    int i, j;
