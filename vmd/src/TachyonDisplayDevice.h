 ...
 *	$Revision: 1.43 $	$Date: 2011/11/10 17:05:35 $
 *
 ***************************************************************************
 * DESCRIPTION:
...
private:
  int enablemirrorspecular;   ///< whether or not to enable mirror reflection
  float phongspecularthresh;  ///< Phong exponent at which specular is enabled
