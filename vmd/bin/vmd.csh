...
#       $Revision: 1.95 $      $Date: 2012/03/18 04:07:38 $
#
############################################################################
# DESCRIPTION:
#
...
##
##    
##  NCSA Blue Waters Cray XK6:
##    set mppwidth=`apstat -r | grep $BATCH_JOBID | awk '{print $5}'`;
##    set mppdepth=`apstat -r | grep $BATCH_JOBID | awk '{print $7}'`;
##    set mppnppn=`apstat -r | grep $BATCH_JOBID | awk '{print $6}'`;
##    # don't let VMD or Tachyon use more cores than we've been given
##    setenv WKFORCECPUCOUNT $mppdepth
##    setenv VMDORCECPUCOUNT $mppdepth
##    echo "Launching VMD with mppwidth=$mppwidth, mppdepth=$mppdepth, mppnppn=$mppnppn"                                                               
##    aprun -B "$MASTERVMDDIR/$execname" $*    
##
##    
